#!/bin/bash
# =============================================================================
# Rollback Cloud Run Service - Backend API
# =============================================================================
# Quick rollback to a previous revision of the Backend API service.
#
# Usage:
...
case $ENV in
    dev)
        ...
        ;;
    prod)
        SERVICE_NAME="document-intelligence-api-prod"
        ;;
    *)
...
echo "============================================="
echo "Backend API Rollback Helper"
echo "============================================="
